...
public class MotionMagicDriveCommand extends CommandBase {
  ...
  public void execute() {
    ...
    if (!motionMagicAutonomousFlag){
      ...
      if( _useAuxPID == false ) {
        RobotContainer.drive.setMotionMagic(distanceInNativeUnit, 4000, 4000); 
      }
      else {
        RobotContainer.drive.configureArcFXDrive(false);
        
        RobotContainer.drive.setMotionMagic(distanceInNativeUnit, RobotContainer.drive.getRemote1SensorReading(), 4000,  4000, true);
      }
    }
  }
