...
public class RunAutoNavSlalom extends SequentialCommandGroup {
  ...
  public RunAutoNavSlalom(RobotOdometry odometry, Drive driveTrain) {
   ...
   // addCommands(new InstantCommand(() -> odometry.setPosition(new Pose2d(30, 30, new Rotation2d()))), mp, new InstantCommand(() -> driveTrain.stop()));
  ...
  public static void main(String[] args) {
    ...
    cmd.mp.visualize(80, 
     List.of(
       /*
     new Translation2d(30, 120), new Translation2d(60, 120), 
     new Translation2d(30, 60), new Translation2d(60, 60), 
     new Translation2d(120, 60), new Translation2d(150, 60), 
     new Translation2d(180, 60), new Translation2d(210, 60), 
     new Translation2d(240, 60), new Translation2d(300, 60)
     */
    ));
  }
}
