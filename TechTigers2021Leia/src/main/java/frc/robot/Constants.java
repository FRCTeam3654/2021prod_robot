...
public final class Constants {
  ...
  public static final class AutoConstants {
    public static final double kMaxSpeedMetersPerSecond = 0.6;  //3, 2.0 , 1.7 , 1.3,  working max 3.0 with Acce at 1.7
    public static final double kMaxAccelerationMetersPerSecondSquared = 0.6; //3, 2.0 , 1.7 , 1.3
